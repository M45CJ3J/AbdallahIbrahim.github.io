...
function Project(id,name, img ,discription, githuburl, productionurl ,vedio, type) {
  ...
  let myArr = [
    ...
    new Project(9,'Image Similarity', './img/image similarity.webp' ,'it is a project to detect the the similar images from Data base , deep learning', null, 'https://youtu.be/iRoYTennCmQ','python'),
  ]
